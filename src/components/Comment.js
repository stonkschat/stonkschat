...
export const Comment = ({ comment, author, theme }) => {
  ...
  return (
    <Card className={classes.root}>
      <CardHeader
        title={(<a className={classes.comment_title} href={comment.link_permalink} target="_blank" rel="noreferrer">
        {comment.link_title}
      </a>)}
      ...
      <CardContent>
        ...
        <Typography variant="h4" className={classes.comment_body}>{comment.body}</Typography>
